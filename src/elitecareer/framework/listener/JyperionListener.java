...
public class JyperionListener implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		PdfPCell cell = new PdfPCell(new Paragraph(getTestClassName(result.getInstanceName()).trim(),
				FontFactory.getFont(FontFactory.HELVETICA, 11, Font.NORMAL, new Color(0, 0, 0))));
		this.successTable.addCell(cell);
	...
	public void onTestFailure(ITestResult result) {
		...
		if (throwable != null) {
			...
			this.nbExceptions++;
			 ...
			 Chunk imdb = new Chunk("[SCREEN SHOT]", new Font(Font.HELVETICA, Font.DEFAULTSIZE, Font.UNDERLINE));
